...
/*
//====================================================================================
bool cDspPanel::isWorking() const
{
    return (m_uiStatus > 0);
}
//====================================================================================
bool cDspPanel::isStatusCanBeSkipped()
{
    bool bRet = true;
...
//====================================================================================
bool cDspPanel::isStatusCanBeReseted()
{
    bool bRet = false;
...
//====================================================================================
int cDspPanel::mainProcessTime()
{
    return m_inMainProcessLength;
}
//====================================================================================
void cDspPanel::setMainProcessTime( const int p_inLength )
{
...
//====================================================================================
void cDspPanel::setMainProcessTime( const int p_inLength, const int p_inPrice )
{
...
//====================================================================================
void cDspPanel::setMainProcessTime( const unsigned int p_uiPatientCardId, const int p_inCountUnits, const int p_inLength )
{
...
//====================================================================================
bool cDspPanel::isTimeIntervallValid( const int p_inLength, int *p_inPrice, int *p_inCount )
{
    QSqlQuery   *poQuery;
    bool         bRet = false;
...
//====================================================================================
void cDspPanel::mousePressEvent ( QMouseEvent * p_poEvent )
{
...
//====================================================================================
void cDspPanel::load( const unsigned int p_uiPanelId )
{
    m_uiId = p_uiPanelId;
...
//====================================================================================
void cDspPanel::formatStatusString( QString p_qsStatusText )
{
    cDBPanelStatusSettings  obDBPanelStatusSettings;
...
//====================================================================================
void cDspPanel::formatTimerString( QString p_qsTimerText )
{
    cDBPanelStatusSettings  obDBPanelStatusSettings;
...
//====================================================================================
void cDspPanel::formatNextLengthString( QString p_qsNextLengthText )
{
    cDBPanelStatusSettings  obDBPanelStatusSettings;
...
//====================================================================================
void cDspPanel::formatInfoString( QString p_qsInfoText )
{
    cDBPanelStatusSettings  obDBPanelStatusSettings;
...
//====================================================================================
QString cDspPanel::convertCurrency( int p_nCurrencyValue, QString p_qsCurrency )
{
...
//====================================================================================
void cDspPanel::activateNextStatus()
{
    if( isMainProcess() )
    {
        // Kezeles vege
...
//====================================================================================
void cDspPanel::cashPayed( const unsigned int p_uiLedgerId )
{
    m_inCashToPay           = 0;
    m_inCashNetToPay        = 0;
    m_inCashDiscountToPay   = 0;
...
//====================================================================================
void cDspPanel::getPanelCashData( unsigned int *p_uiPatientId, int *p_inPrice, int *p_inDiscount )
{
...
//====================================================================================
bool cDspPanel::isHasToPay()
{
    return ( m_inCashToPay > 0 ? true : false );
}
//====================================================================================
QString cDspPanel::getPanelName()
{
    return lblTitle->text();
}
//====================================================================================
bool cDspPanel::isCanBeStartedByTime()
{
    bool    bRet = true;
...
//====================================================================================
bool cDspPanel::isCanBeStartedByCard()
{
    bool    bRet = true;
...
//====================================================================================
void cDspPanel::setPaymentMethod( const unsigned int p_uiPaymentMethodId )
{
    m_uiPaymentMethodId = p_uiPaymentMethodId;
    m_pDBLedgerDevice->setPaymentMethod( m_uiPaymentMethodId );
}
//====================================================================================
bool cDspPanel::isItemInShoppingCart()
{
    return m_bIsItemInShoppingCart;
}
//====================================================================================
void cDspPanel::itemAddedToShoppingCart()
{
    m_bIsItemInShoppingCart = true;
    icoShoppingCart->setVisible( true );
}
//====================================================================================
void cDspPanel::itemRemovedFromShoppingCart()
{
    m_bIsItemInShoppingCart = false;
    icoShoppingCart->setVisible( false );
}
//====================================================================================
unsigned int cDspPanel::panelId()
{
    return m_uiId;
}
//====================================================================================
void cDspPanel::slotShoppingCartClicked()
{
//    this->setFocus();
...
//====================================================================================
void cDspPanel::slotPanelStartClicked()
{
    start();
}
//====================================================================================
void cDspPanel::slotPanelNextClicked()
{
...
//====================================================================================
void cDspPanel::slotPanelStopClicked()
{
    reset();
}
//====================================================================================
void cDspPanel::slotPanelCassaClicked()
{
    emit signalPaymentActivated( m_uiId );
}
//====================================================================================
void cDspPanel::slotScheduledGuestClicked()
{
    emit signalOpenScheduleTable( m_uiId );
}
//====================================================================================
void cDspPanel::patientAddedToWaitingQueue()
{
    m_bIsPatientWaiting = true;
    displayStatus();
}
//====================================================================================
void cDspPanel::patientWaitingQueueEmpty()
{
    m_bIsPatientWaiting = false;
    displayStatus();
}
