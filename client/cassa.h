...
public:
    ...
    unsigned int            cassaProcessPatientCardUnitChange(  const cDBPatientCard &p_DBPatientCard, const cDBShoppingCart &p_obDBShoppingCart, QString p_qsComment, bool p_bIncrease );
