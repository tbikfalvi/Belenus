...
ALTER TABLE `patientcardtypes` ADD `minimumTime` int(11) NOT NULL DEFAULT 0 AFTER `unitTime`;
ALTER TABLE `patientcardunits` ADD `minimumTime` int(11) NOT NULL DEFAULT 0 AFTER `unitTime`;
